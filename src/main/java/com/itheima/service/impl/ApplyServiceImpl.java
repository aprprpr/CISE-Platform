...
public class ApplyServiceImpl implements ApplyService {
    ...
    public List<Apply> getById(Integer teacherId) {
        ...
        applyDao.selectById(teacherId);
        List<Apply> result = applyDao.selectList(null);
        return result;
    }

    @Override
    public List<Apply> getById2(Integer studentId, String project_name, String teacher_name) {
