...
public class AdjuServiceImpl implements AdjuService {
    ...
    @Override
    public List<Judge> queryAllNeedGradeAdju(Integer adjuId) {

        return adjuDao.queryAllNeedGradeAdju(adjuId);
    }

    @Override
    public Judge querySingleNeedGradeAdju(Integer studentId, Integer projectId, Integer adjuId) {
        return adjuDao.querySingleNeedGradeAdju(studentId, projectId, adjuId);
    }
