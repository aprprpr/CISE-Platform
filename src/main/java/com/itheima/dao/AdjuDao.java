...
public interface AdjuDao extends BaseMapper<Adjudicator> {
     ...
     List<Judge> queryAllNeedGradeAdju(@Param("adjud") Integer adjuId);
     Judge querySingleNeedGradeAdju(@Param("studentId") Integer studentId, @Param("projectId") Integer projectId, @Param("adjuId") Integer adjuId);
